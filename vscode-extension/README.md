...
2. Run `Code Mind: Open Web App` to open the full local web UI in VS Code Simple Browser.
...
- Open the full Code Mind web app in VS Code Simple Browser, with a system-browser fallback.
